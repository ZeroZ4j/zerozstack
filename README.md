...
```bash
mvn archetype:generate   -DarchetypeGroupId=com.zeroz4j   -DarchetypeArtifactId=zerozstack-archetype   -DarchetypeVersion=0.9.1
```
...
* **[Limitations](docs/reference/limitations.md)** — every known gap in 0.9.1, stated plainly.
