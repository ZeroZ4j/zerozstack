# ZeroZ Stack: The Zero-Impedance Enterprise Reference Architecture

**ZeroZ Stack is a highly opinionated, pure-Java architectural proof-of-concept designed to eliminate the friction of modern web development.**
...
ZeroZ Stack is fully modular, allowing developers to pick exactly what they need:
...
Available from Maven Central; the version named below is the one this repository builds. Depend on
the modules you need; the BOM keeps versions aligned:
...
```bash
mvn archetype:generate   -DarchetypeGroupId=com.zeroz4j   -DarchetypeArtifactId=zerozstack-archetype   -DarchetypeVersion=0.10.0
```
...
* **[Limitations](docs/reference/limitations.md)** — every known gap in 0.10.0, stated plainly.
