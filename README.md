...
> the two blocks above are the ones it will publish under. Until it goes out, use **0.7.0** in both. <!-- version-check: naming the published release is the whole point of this box, which RELEASING.md has you delete -->
