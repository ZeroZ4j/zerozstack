# Zeroz4j: Core Concepts You Need to Know
...
Zeroz4j bypasses JPA and SQL completely. By using the `zerozstack-store-eclipsestore` module, your Java memory graph *is* your database. You modify your objects in memory, call `storage.store(object)`, and the delta is serialized directly to disk as a binary graph.
