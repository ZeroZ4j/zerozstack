...
The cache name carries the build version — `zeroz4j-shell-0.10.0` — so a deployment evicts
...
java -jar zerozstack-examples/pwa-install/pwa-install-server/target/pwa-install-server-0.10.0.jar
```
