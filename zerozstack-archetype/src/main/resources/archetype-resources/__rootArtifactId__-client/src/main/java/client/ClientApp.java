    ...
    public static void main(String[] args) {
        Zeroz4jClient.connect(getWebSocketUrl(), () -> {
            ...
            RmiSecurityContext.onResolved(() -> {
                ...
                // replaceContents, never setInnerHTML(""): clearing the HTML by hand leaves
                // whatever was on screen still running -- its timers keep firing and can move the
                // keyboard out from under whoever is using the next screen.
                HTMLElement appRoot = Window.current().getDocument().getElementById("app-root");
                Component.replaceContents(appRoot, card);
            });
        });
    }
